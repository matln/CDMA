...
from speakernet.features.signal_processing import (
    compute_amplitude,
    convolve1d,
    dB_to_amplitude,
    reverberate
...
class AddNoise(torch.nn.Module):
    ...
    def forward(self, waveforms, lengths):
        ...
        # 为什么分母要加1呢?是想要加噪声后waveform的平均幅度不变，所以下面 
        # 也对clean signal 进行缩放
        # dB_to_amplitude 输出的是干净信号与噪声信号的幅度比，所以
        # noise_amplitude_factor = noise / (clean + noise)
